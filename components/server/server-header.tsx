      ...
      <DropdownMenuContent className='w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px]'>
        ...
        {isAdmin && (
          <DropdownMenuItem
            ...
            className='px-3 py-2 text-sm cursor-pointer text-rose-500 focus:text-rose-500 dark:focus:text-rose-500'
          >
            Delete Server
        ...
        {!isAdmin && (
          <DropdownMenuItem
            ...
            className='px-3 py-2 text-sm cursor-pointer focus:bg-rose-500'
          >
            Leave Server
